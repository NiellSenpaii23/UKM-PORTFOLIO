...
<div class="w3-containerx" id="contact">
    <div class="w3-content w3-container w3-padding-16" style="max-width:450px">
		<div class="w3-xlarge"><b>Property Listing Request</b></div>
		You have <?PHP echo $count;?> pending list
		<div class="w3-padding"></div>
		
		<?PHP
		$SQL_list = "SELECT * FROM `property` WHERE `status` = 'Pending' ";
		...
		<div class="w3-col s6 w3-padding">
			...
			<a href="a-property.php?id_property=<?PHP echo $id_property;?>" class="w3-text-indigo"><?PHP echo $data["prop_name"]; ?></a><br>
...
<div class="w3-containerx w3-bottom" id="contact">
	...
	<div class="w3-row w3-small">
		...
		<div class="w3-col s3">
			<a href="a-pending.php" class="w3-button w3-hover-green w3-padding-small w3-text-lime">
