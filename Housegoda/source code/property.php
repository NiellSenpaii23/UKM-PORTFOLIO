...
$SQL_list 	= "SELECT * FROM `property`,`user` WHERE property.id_user = user.id_user AND `id_property` = '$id_property'  ";
...
<div class="w3-containerx" id="contact">
    <div class="w3-content w3-container w3-padding-16" style="max-width:600px">
		<a href="photoslide.php?id_property=<?PHP echo $id_property;?>" class="w3-button w3-border w3-border-blue w3-text-blue w3-round"><i class="fas fa-images"></i> Photo</a>
		<?PHP if($video) { ?>
...
<div class="w3-containerx" id="contact">
    <div class="w3-content w3-container " style="max-width:600px">
		<a href="review.php?id_property=<?PHP echo $id_property;?>" class="w3-right w3-tag w3-small w3-round">All Reviews</a>
		...
		<form action="review.php?id_property=<?PHP echo $id_property;?>" method="post" class="">
			<textarea class="w3-input w3-border w3-border-indigo w3-round-xlarge" rows="4" name="review" placeholder="Add a review here.." required></textarea>
			...
			<div class="w3-section">
				...
				<button type="submit" class="w3-padding-large w3-button w3-right w3-margin-bottom w3-round-xxlarge w3-green"><b>SUBMIT</b></button>		
			</div>
	</form>
...
<div class="w3-bottom" >
	<div class="w3-content w3-center w3-padding w3-padding-16" style="max-width:600px">
		<a href="book.php?id_property=<?PHP echo $id_property;?>" class="w3-button w3-green w3-padding w3-padding-16 w3-round-xlarge" style="width:48%"> Book Now</a>
		<a href="tel:<?PHP echo $data["phone"]; ?>" class="w3-button w3-indigo w3-padding w3-padding-16 w3-round-xlarge" style="width:48%"><i class="fas fa-fw fa-phone fa-lg"></i> Call Owner</a>
	</div>
</div>
