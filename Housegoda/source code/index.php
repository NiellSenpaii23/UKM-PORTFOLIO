...
<div class="w3-containerx " id="contact">
	...
	<?PHP } ?>
		...
		<div class="w3-center ">Don't have an account? <a href="register.php" class="w3-text-green">Sign Up</a></div>	
...
<div class="w3-padding-16"></div>
<div class="w3-center "><a href="admin.php" class="w3-text-green">Admin</a></div>	
