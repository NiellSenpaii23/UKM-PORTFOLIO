...
<div class="w3-containerx w3-top" id="contact">
    <div class="w3-content w3-container w3-padding-16 w3-teal w3-center" style="max-width:600px">
		<a href="listing.php" class="w3-left"><i class="fa fa-fw fa-chevron-left fa-lg"></i></a>   
	</div>
</div>
...
<div class="w3-bottom" >
<div class="w3-content  w3-padding w3-padding-16" style="max-width:600px">
<a href="property-edit.php?id_property=<?PHP echo $id_property;?>" class="w3-button w3-block w3-amber w3-padding w3-padding-16 w3-round-xlarge"><i class="fa fa-fw fa-edit fa-lg"></i> Edit</a>
</div>
</div>
