...
{	
	$SQL_insert = " 
	INSERT INTO `review`(`id_review`, `id_property`, `id_user`, `rating`, `review`, `created_date`) 
					VALUES (NULL,'$id_property','$id_user','$rating','$review',NOW()) ";
										
	$result = mysqli_query($con, $SQL_insert);
	
	print "<script>self.location='review.php?id_property=$id_property';</script>";
}
?>
<!DOCTYPE html>
<html>
